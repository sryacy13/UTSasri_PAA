...
import 'screens/tempat_wisata_screen.dart';
            ...
            children: <Widget>[
              const UserAccountsDrawerHeader(
                ...
                decoration: BoxDecoration(
                  gradient: LinearGradient(
                    colors: [
                      Color.fromARGB(255, 125, 236, 222),
                      Color.fromARGB(255, 252, 232, 191),
                    ],
                    begin: Alignment.topLeft,
                    end: Alignment.bottomRight,
                  ),
              ...
              ListTile(
                ...
                onTap: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const TempatWisataScreen()),
                  );
                },
              ),
              const Divider(
